...
const STYLISTIC_CONFIG_NAME_RULES_PRETTIER_MARKDOWN_JSON =
	`${STYLISTIC_CONFIG_NAME_RULES_PRETTIER_MARKDOWN}/json` as const;
const STYLISTIC_CONFIG_NAME_RULES_PRETTIER_MARKDOWN_ASRTO =
...
type StylisticConfigNames =
	...
	| typeof STYLISTIC_CONFIG_NAME_RULES_PRETTIER_MARKDOWN_ASRTO
	| typeof STYLISTIC_CONFIG_NAME_RULES_PRETTIER_MARKDOWN_JSON
