...
const STYLISTIC_CONFIG_NAME_RULES_IMPORTS_MARKDOWN_SOURCE =
	`${STYLISTIC_CONFIG_NAME_RULES_IMPORTS}/markdown/source` as const;
...
type StylisticConfigNames =
	...
	| typeof STYLISTIC_CONFIG_NAME_RULES_IMPORTS_MARKDOWN_SOURCE
