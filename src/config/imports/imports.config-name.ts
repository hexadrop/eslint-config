...
const IMPORTS_CONFIG_NAME_RULES_STATIC_ESLINT_CONFIG = `${IMPORTS_CONFIG_NAME_RULES_STATIC}/eslint-config` as const;
...
type ImportsConfigNames =
	...
	| typeof IMPORTS_CONFIG_NAME_RULES_STATIC_ESLINT_CONFIG
